package com.cgi.UserRegistration.jwtFilter;
...
//	if(httpSession.getAttribute("isLoggedOut")!=null && httpSession.getAttribute("isLoggedOut").equals("true")) {
//		throw new ServletException("User already LoggedOut");
//	}
